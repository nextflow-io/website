...
episode=29
description=We recap of some of the biggest features to be added to Nextflow in 2023 and take a look at some of the things coming in 2024.
date=2024-01-23
type=podcast
...
- 2023
    ...
    - Markdown docs, developer docs
        ...
        - Didn't mention in the recording, but there are [new docs](https://nextflow.io/docs/latest/developer/index.html) aimed at people wanting to develop Nextflow code now too 🎉
