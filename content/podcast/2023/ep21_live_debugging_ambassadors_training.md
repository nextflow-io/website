...
Here, we talk about a new "Nextflow Ambassador" programme that we'll be running for community heroes.
...
The training describes how to create a variant calling analysis pipeline for RNA-seq data-based. It's shorter than the Basic training (1-2 hours, vs. 3x 2.5 hours) and is well suited to those wanting a refresher, or who already have some knowledge about Nextflow.
...
Please use the links above to register
