...
If you're using macOS, the first step is to download the `beta` command group. You can do this by executing:
...
Special thanks to Hatem Nawar and Chris Hakkaart who provided valuable feedback to this document.
